...
streams <- st_read("./Data/Spatial/Habitat/Water_features/WaterFeature_L.shp") # streams shp

cams <- st_read("./Results/indCameras_spatial.shp") # spatial object - independent cams; updated coords
